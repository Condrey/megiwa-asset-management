    ...
    <SessionProvider value={{ session, user }}>
      <div className="[--header-height:calc(--spacing(14))]">
        <SidebarProvider className="flex flex-col ">
          <header className="sticky top-0 z-50 h-(--header-height) flex items-center w-full dark:bg-card bg-primary text-primary-foreground dark:text-card-foreground  dark:border-b">
